# Лабораторная работа №3. Reports Frontend. JavaScript
...
## Задание
Разработать клиентское приложение по теме «Аналитическое моделирование загруженности сетевого оборудования».
...
- создана главная страница со списком карточек;
- реализована страница просмотра конкретной карточки;
- добавлена кнопка возврата назад;
- проект разделён на pages и components;
- реализовано тематическое оформление;
