var u=globalThis,e={},t={},n=u.parcelRequire65e5;null==n&&((n=function(u){if(u in e)return e[u].exports;if(u in t){var n=t[u];delete t[u];var o={id:u,exports:{}};return e[u]=o,n.call(o.exports,o,o.exports),o.exports}var r=Error("Cannot find module '"+u+"'");throw r.code="MODULE_NOT_FOUND",r}).register=function(u,e){t[u]=e},u.parcelRequire65e5=n),(0,n.register)("45f4g",function(u,e){Object.defineProperty(u.exports,"injectStyles",{get:()=>n,set:void 0,enumerable:!0,configurable:!0});let t=`
    @font-face {
        font-family: 'Figtree';
...
`,n=()=>{if(!document.getElementById("cloudcalc-styles")){let u=document.createElement("style");u.id="cloudcalc-styles",u.textContent=t,document.head.appendChild(u)}}});var o=n("45f4g");let r="/api/requests",a=null;async function i(u){try{let e=await fetch(`${r}/${u}`);if(!e.ok)throw Error("Заявка не найдена");let t=await e.json();document.getElementById("equipmentType").value=t.equipmentType||"",document.getElementById("modelingType").value=t.modelingType||"",document.getElementById("status").value=t.status||"pending",t.inputData&&(document.getElementById("packetArrivalRate").value=t.inputData.packetArrivalRate||"")}catch(u){console.error("Ошибка загрузки:",u),alert("Не удалось загрузить данные заявки.")}}async function l(u){u.preventDefault();let e={equipmentType:document.getElementById("equipmentType").value.trim(),modelingType:document.getElementById("modelingType").value.trim(),status:document.getElementById("status").value,inputData:{packetArrivalRate:parseFloat(document.getElementById("packetArrivalRate").value)}},t=a?"PUT":"POST",n=a?`${r}/${a}`:r;try{if((await fetch(n,{method:t,headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})).ok)alert(a?"Заявка успешно обновлена!":"Заявка успешно создана!"),window.location.href="index.html";else throw Error("Ошибка при сохранении")}catch(u){console.error(u),alert("Не удалось сохранить данные. Проверьте работу сервера.")}}document.addEventListener("DOMContentLoaded",()=>{(0,o.injectStyles)(),(a=new URLSearchParams(window.location.search).get("id"))?(document.getElementById("formTitle").textContent=`\u{420}\u{435}\u{434}\u{430}\u{43A}\u{442}\u{438}\u{440}\u{43E}\u{432}\u{430}\u{43D}\u{438}\u{435} \u{437}\u{430}\u{44F}\u{432}\u{43A}\u{438} #${a}`,i(a)):document.getElementById("formTitle").textContent="Создание новой заявки",document.getElementById("editForm").addEventListener("submit",l)});
//# sourceMappingURL=edit.d23452ec.js.map
